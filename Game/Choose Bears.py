        ...
        input('Game rules:There are 100 bears in total.You can take some bears away---at least one bears and the most is ten bears.If the final is taken away by you,you win.Or,zhanshen win it!Good Luck!!      ')
        input(' ')
        b=int(input('Choose how many bears in total'));c=int(input('Choose how many you take away a time'));sx=0;zs=0
        while b>0:
